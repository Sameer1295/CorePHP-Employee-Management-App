...
if(isset($_POST['login'])){
    ...
    $res = $obj->checkUser($u_name,$u_pass);
    if(empty($res)){
        echo "User/Password does not match..";
    }else{
        $_SESSION['u_name'] = $res[0]['user_name'];
...
<body>
    <div class="container">
        ...
        <div class="form-group">
            ...
            <input type="text" name="user_name" class="form-control" id="exampleInputUser" aria-describedby="emailHelp">
        </div>
        <div class="form-group">
